...
public class RobotContainer {
    ...
    private void configureCommands() {
        ...
        m_feeder.setDefaultCommand(
                new RunCommand(() ->
                        m_feeder.setPWM(Deadband.linearScaledDeadband(
                                m_suraj.getY(GenericHID.Hand.kRight), Constants.OI.XBOX_DEADBAND)), m_feeder)

        );


        //top magazine  pwm manual
        m_highMagazine.setDefaultCommand(
                new RunCommand(() ->
                        m_highMagazine.setPWM(Deadband.linearScaledDeadband(
                                -m_suraj.getY(GenericHID.Hand.kRight), Constants.OI.XBOX_DEADBAND)), m_highMagazine
        ...
        //        );
        //
        //        //hood position manual
        //        m_suraj.getJoystickButton(XboxController.Button.kY).whenHeld(
        //                new SetHood(m_hood, Deadband.linearScaledDeadband(
        ...
        //        m_suraj.getJoystickAxisButton(XboxController.Axis.kLeftTrigger, Constants.OI.XBOX_DEADBAND).whileHeld(
        //                new RunCommand(
        //                        () -> {
        ...
        //                )
        //        );
        //        m_lowMagazine.setDefaultCommand(new RunCommand(()->
        //                m_lowMagazine.setPWM(Deadband.linearScaledDeadband(m_jack.getY(GenericHID.Hand.kRight), Constants.OI.XBOX_DEADBAND)), m_lowMagazine));
        //
        ...
        m_flywheels.setDefaultCommand(
                new RunCommand(()->m_flywheels.setPWM(
                        Deadband.linearScaledDeadband(-m_suraj.getTriggerAxis(GenericHID.Hand.kRight), Constants.OI.XBOX_DEADBAND)
                ), m_flywheels)
        );
        ...
        //                new RunCommand(()-> m_intakeArm.setPWM(Deadband.linearScaledDeadband(-m_jack.getX(GenericHID.Hand.kRight), 0.1)))
        //        ).whenReleased(
        //                new RunCommand(() -> m_intakeArm.setPWM(0))
        //        );

        //        m_intakeArm.setDefaultCommand(
        //                new RunCommand(()-> m_intakeArm.setPWM(Deadband.linearScaledDeadband(-m_jack.getX(GenericHID.Hand.kRight), 0.1)), m_intakeArm)
        //        );

        //        m_jack.getJoystickButton(XboxController.Button.kY).whenHeld(
        //                new RunCommand(()->
        //                        m_climber.setPWM(Deadband.linearScaledDeadband(m_jack.getY(GenericHID.Hand.kRight), Constants.OI.XBOX_DEADBAND))
        //                        )
        //        );

        m_lowMagazine.setDefaultCommand(
    ...
    public void testInit() {
        ...
        SmartDashboard.putBoolean("Turret Soft Limits", false);

//        setHood = new SetHood(m_hood, ()->45);
    }

    public void testPeriodic() {
        boolean enabled = SmartDashboard.getBoolean(Constants.TUNE_ENABLE_LABEL, false);
        ...
        m_turret.enableSoftLimits(SmartDashboard.getBoolean("Turret Soft Limits", false));
