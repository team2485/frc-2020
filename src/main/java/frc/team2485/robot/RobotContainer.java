...
//                            m_lowMagazine.setPWM(Constants.Magazine.LOW_BELT_PWM);
                        ...
                        () -> {
                            return m_ballCounter.getNumBallsHigh() < Constants.Magazine.HIGH_MAGAZINE_BALL_CAPACITY || !m_ballCounter.getTransferIR();
        ...
        m_jack.getJoystickButton(XboxController.Button.kA).whileHeld(
                new ConditionalCommand(
                        ...
                        () -> {
                            return m_ballCounter.getTransferIR() && m_ballCounter.getNumBallsHigh() < Constants.Magazine.HIGH_MAGAZINE_BALL_CAPACITY;
                        }
                )
        ).whenReleased(
                new InstantCommand(() -> {
