...
//    else if(time<3) m_robotContainer.sendWidget1data(0,(time-2)*360);
...
//    else if(time<6) m_robotContainer.sendWidget1data((time-5)*360,0);
//
...
//    else if(time<3) m_robotContainer.sendWidget2data(Math.PI/4.0,(time-2)*30);
...
//    else if(time<6) m_robotContainer.sendWidget2data((time-5)*Math.PI/2.0,15);
